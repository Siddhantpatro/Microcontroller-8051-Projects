...
if (s1==1)
{
while (s1 == 1);//check if switch 1 is pressed
{
v1 = v1 + 1;
if(v1==10)
v1=0;
...
if (s2==1)//check if switch 2 is pressed
...
if (s3==1)//check if switch 3 is pressed
{
while (s3 == 1);
{
v3 = v3 + 1;
...
if (s4==1)//check if switch 4 is pressed
{
while (s4 == 1);
{
v4 = v4 + 1;
...
{
v1 = v2 = v3 = v4 = 0;
s1 = s2 = s3 = s4 = 0;// Initialize the input pins
while(1)
{
calc_vote();
}
